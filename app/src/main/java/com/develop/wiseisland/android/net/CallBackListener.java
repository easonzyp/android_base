...
public abstract class CallBackListener<T> {
    ...
    public static abstract class CallBackDefault extends CallBackListener<Response> {
        @Override
    ...
    public static abstract class CallBackString extends CallBackListener<String> {
        @Override
    ...
    public static abstract class CallBackJsonObject extends CallBackListener<JSONObject> {
        @Override
    ...
    public static abstract class CallBackJsonArray extends CallBackListener<JSONArray> {
        @Override
        public JSONArray onParseResponse(Call call, Response response) {
            try {
    ...
    public static abstract class CallBackBitmap extends CallBackListener<Bitmap> {
     ...
     * 下载文件时的回调类
     */
    public static abstract class CallBackFile extends CallBackListener<File> {
