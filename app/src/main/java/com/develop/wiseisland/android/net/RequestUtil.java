...
public class RequestUtil {
    ...
    private CallBackListener mCallBack;//回调接口
    private okhttp3.OkHttpClient mOkHttpClient;//OKhttpClient对象
    private Request mOkHttpRequest;//请求对象
    private Request.Builder mRequestBuilder;//请求对象的构建者


    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackListener callBack) {
        this(methodType,url,null,null,null,null,null,null,paramsMap,headerMap,callBack);
    }

    RequestUtil(String methodType, String url, String jsonStr, Map<String, String> headerMap, CallBackListener callBack) {
        this(methodType,url,jsonStr,null,null,null,null,null,null,headerMap,callBack);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, File file, String fileKey, String fileType, Map<String, String> headerMap, CallBackListener callBack) {
        this(methodType,url,null,file,null,fileKey,null,fileType,paramsMap,headerMap,callBack);
    }
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, List<File> fileList, String fileKey, String fileType, Map<String, String> headerMap, CallBackListener callBack) {
        this(methodType,url,null,null,fileList,fileKey,null,fileType,paramsMap,headerMap,callBack);
    }
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, File> fileMap, String fileType, Map<String, String> headerMap, CallBackListener callBack) {
        this(methodType,url,null,null,null,null,fileMap,fileType,paramsMap,headerMap,callBack);
    }

    private RequestUtil(String methodType, String url, String jsonStr ,File file ,List<File> fileList,String fileKey , Map<String,File> fileMap,String fileType,Map<String, String> paramsMap,Map<String, String> headerMap, CallBackListener callBack) {
    ...
    private void getInstance(){
        ...
        if(mFile != null || mfileList != null || mfileMap != null){//先判断是否有文件，
            ...
            //设置参数
            switch (mMetyodType){
                case OkHttpClient.METHOD_GET:
                    setGetParams();
                    break;
                case OkHttpClient.METHOD_POST:
                    mRequestBuilder.post(getRequestBody());
                    break;
                case OkHttpClient.METHOD_PUT:
                    mRequestBuilder.put(getRequestBody());
                    break;
                case OkHttpClient.METHOD_DELETE:
    ...
    private static class ProgressRequestBody extends RequestBody {
        ...
        ProgressRequestBody(RequestBody requestBody, CallBackListener callBack) {
        ...
        private Sink sink(BufferedSink sink) {
            return new ForwardingSink(sink) {
                ...
                public void write(Buffer source, long byteCount) throws IOException {
                    ...
                    CallBackListener.mMainHandler.post(new Runnable() {
                        @Override
                        public void run() {
